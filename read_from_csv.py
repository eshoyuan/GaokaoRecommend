...
with open(file_path, 'r', encoding='UTF-8') as f:
    ...
    for row in reader:
        ...
        CollegeApplication.objects.update_or_create(school_text=row[0],
                                                    ...
                                                    is_985=row[7],
                                                    is_211=row[8],
                                                    Phy=subject_request[0],
                                                    Che=subject_request[1],
                                                    Bio=subject_request[2],
                                                    Pol=subject_request[3],
                                                    His=subject_request[4],
                                                    Geo=subject_request[5],
                                                    request=subject_request[6],
