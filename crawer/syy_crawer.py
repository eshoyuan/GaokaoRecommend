...
def get_text(university=0, batchName=0, yearNum=0):
    ...
    textUrl = 'https://gaokao.baidu.com/gaokao/gkschool/majorscore?ajax=1&batchName={}&curriculum=&needFilter=0&pn=1&province=%E6%B2%B3%E5%8C%97&rn=50&school={}&sortType=&year={}'.format(
